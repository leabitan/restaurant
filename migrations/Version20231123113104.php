 ...
 */
final class Version20231123113104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD stock_id INT DEFAULT NULL, DROP stock');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD stock INT NOT NULL, DROP stock_id');
    }
}
